...
urlpatterns = [
    ...
    path('news/interest/<int:interest_id>', views.news_by_interest),   # GET /news/interest/<id>  get all news of an interest
    ...
    path('authors/<int:author_id>/news/', views.news_by_author), # GET /author/<id>/news/  get all news of an author
